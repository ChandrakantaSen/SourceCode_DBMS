SELECT IDRV.REGN                                                  REGN
      ...
      NVL(BILL_TO_APS_APD_PRIMARY.BILL_TO_SITE_USE_ID,NVL(BILL_TO_APS_APD_SECONDARY.BILL_TO_SITE_USE_ID,IDRV.RCTA_BILL_TO_SITE_USE_ID))))                              BILL_TO
      ,SUM(CASE
...
WHERE IDRV.HCA_ACCOUNT_NUMBER = BILL_TO_PRIMARY.HCA_ACCOUNT_NUMBER(+)
...
GROUP BY IDRV.REGN                                               
      ...
      NVL(BILL_TO_APS_APD_SECONDARY.BILL_TO_SITE_USE_ID,IDRV.RCTA_BILL_TO_SITE_USE_ID))))                            
ORDER BY 1,2,3,4,5;