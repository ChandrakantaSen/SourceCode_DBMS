SELECT IDRV.REGN                                                  REGN
      ...
      ,SUM(CASE
               WHEN IDRV.CUST_TYPE <> '55' AND idrv.DEPO_CODE  =    '113'    THEN IDRV.FNL_VOL         
               WHEN IDRV.CUST_TYPE <> '55' AND idrv.DEPO_CODE  <>'113' AND TO_NUMBER(TO_CHAR(IDRV.INV_DATE,'DD')) <= 20    THEN IDRV.FNL_VOL         
               ELSE 0
           END)                                                   FNL_VOL
  FROM
       -- ******************************* -- 
          ...
          (
            SELECT MSIB.INVENTORY_ITEM_ID
             ...
             WHERE MSIB.ORGANIZATION_ID = 102 
               AND MSIB.SEGMENT1 LIKE 'F00%'PASS
     ...
     WHERE RCTA.CUSTOMER_TRX_ID            = RCTLA.CUSTOMER_TRX_ID   
       ...
       AND TO_NUMBER(TO_CHAR(RCTA.TRX_DATE,'DD')) <= 20
      )  IDRV,
