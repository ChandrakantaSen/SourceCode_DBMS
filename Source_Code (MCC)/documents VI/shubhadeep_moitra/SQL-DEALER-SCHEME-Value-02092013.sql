  ...
  FROM
      ...
      FROM RA_CUSTOMER_TRX_LINES_ALL RCTLA,  
          ...
          (
           ...
           BPIL.BPIL_MCC_CUST_MSTR_SCHM_V RDTCAV,
           -- ============================================ --   
     ...
     WHERE RCTA.CUSTOMER_TRX_ID            = RCTLA.CUSTOMER_TRX_ID    
       ...
       AND RDTCAV.BILL_TO_ID               = RCTA.BILL_TO_SITE_USE_ID   
       ...
       AND (TO_NUMBER(TO_CHAR(RCTA.TRX_DATE,'YYYYMM')) = 201107
        OR  TO_NUMBER(TO_CHAR(RCTA.TRX_DATE,'YYYYMM')) = 201207) 
      )  IDRV,
